  ...
  <div class="container" style="max-width: 800px;">
    ...
    <div class="jg-card p-4">
      <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <!-- Campo para el email del usuario, con validación y estilos personalizados -->
        <div class="mb-3">
        ...
        <!-- Campo para seleccionar el rol del usuario, con validación y estilos personalizados -->
        <div class="mb-3">
        ...
        <div class="row mb-4">
          ...
          <!-- Campo para confirmar la contraseña, con estilos personalizados -->
          <div class="col-md-6">
