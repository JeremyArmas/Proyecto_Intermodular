    ...
    <div class="jg-card p-4 mt-3">
        ...
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" name="is_published" id="publishedSwitch" {{ $news->is_published ? 'checked' : '' }}> <!-- El {{ $news->is_published ? 'checked' : '' }} es para que si por ejemplo está en modo borrador y le cambio el título , no se publique solo.-->
